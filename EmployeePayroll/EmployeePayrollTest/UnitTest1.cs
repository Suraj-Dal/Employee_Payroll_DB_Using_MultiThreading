...
namespace EmployeePayrollTest
{
    public class Tests
    {
        ...
        public void GivenListOfMultipleEmployee_AddIntoDataBase_TestTimeWithout_MutltiThreading()
        {
            ...
            employeeProfiles.Add(new EmployeeProfile(id: 10, name: "Sagar", salary: 21000, dateTime: DateTime.Now, gender: "M", phone: 9542668274, address: "Pune", dept: "IT", basicPay: 21000, deductions: 1200, taxablePay: 1000, incomeTax: 2100, netPay:19000));
            employeeProfiles.Add(new EmployeeProfile(id: 11, name: "Nitin", salary: 23000, dateTime: DateTime.Now, gender: "M", phone: 6387758748, address: "Pune", dept: "Sales", basicPay: 23000, deductions: 1400, taxablePay: 1300, incomeTax: 2300, netPay: 21000));
