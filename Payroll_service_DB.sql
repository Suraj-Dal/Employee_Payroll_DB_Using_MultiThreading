...
update employee_payroll set phone_number=9876512345 where name='Suraj';
update employee_payroll set phone_number=9423375244 where name='Sanket';
update employee_payroll set phone_number=8988964543 where name='Akshay';
update employee_payroll set phone_number=9978563412 where name='Nita';
update employee_payroll set phone_number=8766754537 where name='Aditi';
update employee_payroll set phone_number=8977874532 where name='Shikha';
update employee_payroll set phone_number=8595678845 where id=10;
...
select * from employee_payroll
alter table employee_payroll drop column deductions, Taxable_Pay, Income_Tax, Net_Pay;
...
AS
BEGIN
INSERT INTO employee_payroll VALUES(@name,@salary,@startDate,@Gender,@phone_number,@address,@department,@basic_pay)
END
